mod syntax {
    pub mod kw {
        ...
        pub fn yeet<__S: ::syn::__private::IntoSpans<::syn::__private::Span>>(
            span: __S,
        ) -> yeet {
            yeet {
        ...
        const _: () = {
            ...
            impl ::syn::token::CustomToken for Elvis {
                fn peek(cursor: ::syn::buffer::Cursor) -> bool {
                    ::syn::__private::peek_punct(cursor, "?:")
                }
                fn display() -> &'static ::syn::__private::str {
                    "`?:`"
                }
            ...
            impl ::syn::parse::Parse for Elvis {
                fn parse(
                    input: ::syn::parse::ParseStream,
                ) -> ::syn::parse::Result<Elvis> {
                    let spans: [::syn::__private::Span; 0 + 1 + 1] = ::syn::__private::parse_punct(
                        input,
                        "?:",
                    )?;
                    Ok(Elvis(spans))
            ...
            impl ::syn::__private::ToTokens for Elvis {
                fn to_tokens(&self, tokens: &mut ::syn::__private::TokenStream2) {
                    ::syn::__private::print_punct("?:", &self.spans, tokens)
                }
            }
...
fn main() {
    ...
    let _ = <::syn::token::PathSep>::default();
}
